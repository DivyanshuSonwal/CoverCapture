        ...
        <div className="md:p-20 bg-gray-100">
            ...
            <div className=" p-20 ">
                <div className="flex flex-col items-center">
                    ...
                    <h1 className="text-2xl text-purple-400 ">CoverCapture</h1>
                </div>
                ...
                <a href="https://github.com/DivyanshuSonwal/CoverCapture" target="_blank" rel="noreferrer" className="bg-gray-700 text-white p-2 px-6 rounded text-xl flex my-10 hover:bg-gray-800 mx-auto w-max">⭐ Star on Github</a>
            </div>
